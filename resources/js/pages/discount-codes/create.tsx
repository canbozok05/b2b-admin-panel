...
export default function DiscountCodeCreate({ products, categories }: Props) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post(discountCodes.store.url());
    }

    return (
        <>
            <Head title="Yeni İndirim Kodu" />

            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <h1 className="text-2xl font-semibold">Yeni İndirim Kodu</h1>
